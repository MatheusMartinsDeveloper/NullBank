...
export default function CardAdvantages({ icon, advantage, description }: CardAdvantagesProps) {
    return (
        <div className="relative overflow-hidden flex justify-center items-center bg-primaryColorLight rounded-md w-[18em] h-[13em] card-advantages-after hover:card-advantages-after-hover mobile:justify-start mobile:pl-5" data-aos="fade-up">
