    ...
    return (
        <section className="flex justify-around items-center bg-backgroundColor w-full h-[95vh]">
            <div className="relative">
                ...
                <div className="flex justify-center items-center absolute top-72 -right-10 bg-primaryColorLight rounded-2xl w-[30%] h-[13%]">
                    <FaClock size={40} className="text-primaryColorMain" />
                </div>
                <div className="flex justify-center items-center absolute top-[90%] -left-10 bg-primaryColorLight rounded-2xl w-[30%] h-[13%]">
                    <RiExchangeBoxFill size={40} className="text-primaryColorMain" />
                </div>
            </div>
            <div className="flex flex-col items-start gap-10">
                <div className="space-y-2">
                    <span className="text-primaryColorMain text-base font-Poppins font-bold tracking-widest">App</span>
                    <h1 className="text-grayColorExtra text-4xl font-Poppins font-semibold">Faça tudo pelo app</h1>
                    <p className="text-grayColorDark text-base font-Poppins font-normal">Tudo o que você precisa, apenas um aplicativo. Crie uma conta, <br />
