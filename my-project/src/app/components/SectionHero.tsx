    ...
    return(
        <section className="flex justify-between w-full h-[93vh]">
            ...
            <div className="relative flex justify-center items-center bg-primaryColorMain w-full h-full">
                <div>
                    <Image className="absolute top-56 left-36 z-50 animate-bounce-y" src={CardFront} alt="Imagem Cartão" quality={100} />
                    <Image className="absolute top-80 left-[25%] z-0 animate-bounce-x" src={CardBack} alt="Imagem Cartão" quality={100} />
                </div>
            </div>
        </section>
    );
